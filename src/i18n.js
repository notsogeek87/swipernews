...
(function (root, factory) {
  ...
  const STRINGS = {
    fr: {
      ...
      "stats.mo.10": "Nov",
      "stats.mo.11": "Déc",
      "stats.barAria": "{label} : {n} cartes",
      "stats.readout": "{label} : {n} cartes",
      "stats.readoutHint": "Touche une barre pour voir le détail",
      "stats.chart.aria.hour":
        "Cartes défilées par tranche de 15 minutes, heure en cours",
      "stats.chart.aria.day": "Cartes défilées par heure, aujourd'hui",
      "stats.chart.aria.week": "Cartes défilées par jour, cette semaine",
      "stats.chart.aria.month": "Cartes défilées par semaine, ce mois-ci",
      "stats.chart.aria.year": "Cartes défilées par mois, cette année",
      "stats.table.show": "Voir les données",
      "stats.table.hide": "Masquer les données",
      "stats.table.caption": "Cartes défilées par période — {period}",
      "stats.table.period": "Période",
      "stats.table.count": "Cartes",
    ...
    en: {
      ...
      "stats.mo.10": "Nov",
      "stats.mo.11": "Dec",
      "stats.barAria": "{label}: {n} cards",
      "stats.readout": "{label}: {n} cards",
      "stats.readoutHint": "Tap a bar to see the detail",
      "stats.chart.aria.hour": "Cards scrolled per 15-minute slice, current hour",
      "stats.chart.aria.day": "Cards scrolled per hour, today",
      "stats.chart.aria.week": "Cards scrolled per day, this week",
      "stats.chart.aria.month": "Cards scrolled per week, this month",
      "stats.chart.aria.year": "Cards scrolled per month, this year",
      "stats.table.show": "View data",
      "stats.table.hide": "Hide data",
      "stats.table.caption": "Cards scrolled by period — {period}",
      "stats.table.period": "Period",
      "stats.table.count": "Cards",
