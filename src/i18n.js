  ...
  const STRINGS = {
    fr: {
      ...
      "changelog.v222.item2":
        "🎨 Réglages : le doublon « Thème » / « Couleurs » a disparu, un seul titre.",
      ...
      "stats.sub": "Ton activité dans l'app, par période.",
      "stats.hour": "Cette heure",
      "stats.day": "Aujourd'hui",
      "stats.week": "Cette semaine",
      "stats.month": "Ce mois-ci",
      "stats.year": "Cette année",
      "stats.metricLabel": "Choisir l'activité",
      "stats.metric.cards": "Cartes défilées",
      "stats.metric.opens": "Articles ouverts",
      "stats.unit.cards": "cartes",
      "stats.unit.opens": "articles",
      "stats.periodLabel": "Choisir la période",
      "stats.tab.hour": "Heure",
      "stats.tab.day": "Jour",
      "stats.tab.week": "Semaine",
      "stats.tab.month": "Mois",
      "stats.tab.year": "Année",
      "stats.hourShort": "{h}h",
      "stats.wd.0": "Lun",
      "stats.wd.1": "Mar",
      "stats.wd.2": "Mer",
      ...
      "stats.mo.10": "Nov",
      "stats.mo.11": "Déc",
      "stats.barAria": "{label} : {n} {unit}",
      "stats.readout": "{label} : {n} {unit}",
      "stats.readoutHint": "Touche une barre pour voir le détail",
      "stats.chart.aria.hour": "{metric} par tranche de 15 minutes, heure en cours",
      "stats.chart.aria.day": "{metric} par heure, aujourd'hui",
      "stats.chart.aria.week": "{metric} par jour, cette semaine",
      "stats.chart.aria.month": "{metric} par semaine, ce mois-ci",
      "stats.chart.aria.year": "{metric} par mois, cette année",
      "stats.table.show": "Voir les données",
      "stats.table.hide": "Masquer les données",
      "stats.table.caption": "{metric} par période — {period}",
      "stats.table.period": "Période",
      "stats.cmp.ref.hour": "à l'heure précédente",
      "stats.cmp.ref.day": "à hier",
      "stats.cmp.ref.week": "à la semaine dernière",
      "stats.cmp.ref.month": "au mois dernier",
      "stats.cmp.ref.year": "à l'année dernière",
      "stats.cmp.flat": "Aucune évolution par rapport {ref}",
      "stats.cmp.upAbs": "+{n} par rapport {ref}",
      ...
      "sheet.sources.deleteConfirmAria": "Confirmer la suppression de {name} ?",
      ...
      "toast.feedDiscovering": "Recherche du flux…",
      "toast.feedNotFound": "Impossible de trouver le flux RSS de ce site.",
    ...
    en: {
      ...
      "changelog.v222.item2":
        "🎨 Settings: the “Theme” / “Colors” duplicate heading is gone, down to one title.",
      "changelog.v221.item1":
      ...
      "stats.sub": "Your activity in the app, by period.",
      "stats.hour": "This hour",
      "stats.day": "Today",
      "stats.week": "This week",
      "stats.month": "This month",
      "stats.year": "This year",
      "stats.metricLabel": "Choose the activity",
      "stats.metric.cards": "Cards scrolled",
      "stats.metric.opens": "Articles opened",
      "stats.unit.cards": "cards",
      "stats.unit.opens": "articles",
      "stats.periodLabel": "Choose the period",
      "stats.tab.hour": "Hour",
      "stats.tab.day": "Day",
      "stats.tab.week": "Week",
      ...
      "stats.barAria": "{label}: {n} {unit}",
      "stats.readout": "{label}: {n} {unit}",
      "stats.readoutHint": "Tap a bar to see the detail",
      "stats.chart.aria.hour": "{metric} per 15-minute slice, current hour",
      "stats.chart.aria.day": "{metric} per hour, today",
      "stats.chart.aria.week": "{metric} per day, this week",
      "stats.chart.aria.month": "{metric} per week, this month",
      "stats.chart.aria.year": "{metric} per month, this year",
      "stats.table.show": "View data",
      "stats.table.hide": "Hide data",
      "stats.table.caption": "{metric} by period — {period}",
      "stats.table.period": "Period",
      "stats.cmp.ref.hour": "the previous hour",
      "stats.cmp.ref.day": "yesterday",
      "stats.cmp.ref.week": "last week",
      "stats.cmp.ref.month": "last month",
      "stats.cmp.ref.year": "last year",
      "stats.cmp.flat": "No change compared to {ref}",
      "stats.cmp.upAbs": "+{n} compared to {ref}",
      ...
      "sheet.sources.deleteConfirmAria": "Confirm deleting {name}?",
      ...
      "toast.feedDiscovering": "Looking up the feed…",
      "toast.feedNotFound": "Could not find this site's RSS feed.",
